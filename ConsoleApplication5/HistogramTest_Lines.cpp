...
#pragma endregion
	...
	circle(src, maskCentroid[0], 1, Scalar(0, 255, 0), 1, 8, 0);
...
#pragma region walk in edge angle direction
	...
	for (size_t i = 0; i < 10; i++)
	{
		...
		circle(src, w1, 1, Scalar(0, 0, 255), 1, 8, 0);
		circle(src, w2, 1, Scalar(255, 0, 0), 1, 8, 0);
		u2 = w1;
		u22 = w2;
	}
#pragma endregion
...
#pragma region walk perpendicular in edge angle direction
		...
		for (size_t i = 0; i < 10; i++)
		{
			...
			circle(src, ww2, 1, Scalar(255, 255, 0), 1, 8, 0); //turqoise
			uu2 = ww1;
			uu22 = ww2;
		}
#pragma endregion
